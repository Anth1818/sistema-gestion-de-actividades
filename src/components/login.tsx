    ...
    <Card className="w-[320px]">
      ...
      <CardFooter className="flex flex-col gap-4 justify-center">
        <div className="w-full">
          ...
          <a onClick={handleGoToRecoverPassword} className="block text-center text-blue-600 cursor-pointer">
            <span className="hover:bg-gray-300 p-1 rounded">¡Clic aquí!</span>
          </a>
        </div>
      </CardFooter>
    </Card>
